...
//!
//! Подпись конвертов/ACL (A2) — вне scope: заблокирована S6 (схема
//! ACL-манифеста плагина, `security-model.md` §4, ещё не реализована).
//! [`berimor_storage::Envelope`] здесь несёт адресацию, не подпись.
