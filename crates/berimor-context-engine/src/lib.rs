...
/// Находка 4.6 аудита: измерение в БАЙТАХ (`str::len`), не в Unicode-
/// символах — для кириллицы (2 байта/символ) эффективный бюджет вдвое
/// меньше «символьного» прочтения. Это осознанно консервативно (байты —
/// верхняя граница токенов надёжнее) и согласовано между модулями;
/// имена функций исторические, контракт фиксируется здесь.
