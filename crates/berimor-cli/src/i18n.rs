...
pub struct Strings {
    ...
    // Меню параметров /config (2026-08-12: «/config > модалка > Locale»).
    pub settings_menu_title: &'static str,
    pub settings_show: &'static str,
    pub settings_locale: &'static str,
    // Модал human.ask (B7): вопрос агента со свободным ответом.
    pub ask_title: &'static str,
    pub ask_hint: &'static str,
    // Описания slash-команд (палитра и /help).
    pub slash_help: &'static str,
    pub slash_config: &'static str,
    pub slash_config_locale: &'static str,
...
const RU: Strings = Strings {
    ...
    settings_menu_title: "Параметры (Enter — выбрать)",
    settings_show: "Показать эффективную конфигурацию",
    settings_locale: "Локаль интерфейса (язык)",
    ask_title: " вопрос агента ",
    ask_hint: " Enter — ответить · Esc — отмена",
    slash_help: "список команд",
    slash_config: "эффективная конфигурация",
    slash_config_locale: "локаль интерфейса (пикер или код: ru, en, …)",
...
const EN: Strings = Strings {
    ...
    settings_menu_title: "Settings (Enter — select)",
    settings_show: "Show effective configuration",
    settings_locale: "Interface locale (language)",
    ask_title: " agent question ",
    ask_hint: " Enter — answer · Esc — cancel",
    slash_help: "command list",
    slash_config: "effective configuration",
    slash_config_locale: "interface locale (picker or code: ru, en, …)",
...
const DE: Strings = Strings {
    ...
    settings_menu_title: "Einstellungen (Enter — wählen)",
    settings_show: "Effektive Konfiguration anzeigen",
    settings_locale: "Oberflächensprache",
    ask_title: " Frage des Agenten ",
    ask_hint: " Enter — antworten · Esc — abbrechen",
    slash_help: "Befehlsliste",
    slash_config: "effektive Konfiguration",
    slash_config_locale: "Oberflächensprache (Picker oder Code: ru, en, …)",
...
const FR: Strings = Strings {
    ...
    settings_menu_title: "Paramètres (Enter — choisir)",
    settings_show: "Afficher la configuration effective",
    settings_locale: "Langue de l'interface",
    ask_title: " question de l'agent ",
    ask_hint: " Enter — répondre · Esc — annuler",
    slash_help: "liste des commandes",
    slash_config: "configuration effective",
    slash_config_locale: "langue de l'interface (sélecteur ou code : ru, en, …)",
...
const ES: Strings = Strings {
    ...
    settings_menu_title: "Parámetros (Enter — elegir)",
    settings_show: "Mostrar configuración efectiva",
    settings_locale: "Idioma de la interfaz",
    ask_title: " pregunta del agente ",
    ask_hint: " Enter — responder · Esc — cancelar",
    slash_help: "lista de comandos",
    slash_config: "configuración efectiva",
    slash_config_locale: "idioma de la interfaz (selector o código: ru, en, …)",
...
const ZH_CN: Strings = Strings {
    ...
    settings_menu_title: "设置(Enter — 选择)",
    settings_show: "显示生效配置",
    settings_locale: "界面语言",
    ask_title: " 代理提问 ",
    ask_hint: " Enter — 回答 · Esc — 取消",
    slash_help: "命令列表",
    slash_config: "生效配置",
    slash_config_locale: "界面语言(选择器或代码:ru、en、…)",
    slash_models: "模型提供商",
...
const JA: Strings = Strings {
    ...
    settings_menu_title: "設定(Enter — 選択)",
    settings_show: "有効な設定を表示",
    settings_locale: "UI 言語",
    ask_title: " エージェントの質問 ",
    ask_hint: " Enter — 回答 · Esc — キャンセル",
    slash_help: "コマンド一覧",
    slash_config: "有効な設定",
    slash_config_locale: "UI 言語(選択またはコード: ru, en, …)",
...
const KO: Strings = Strings {
    ...
    settings_menu_title: "설정(Enter — 선택)",
    settings_show: "유효 구성 보기",
    settings_locale: "인터페이스 언어",
    ask_title: " 에이전트 질문 ",
    ask_hint: " Enter — 답변 · Esc — 취소",
    slash_help: "명령 목록",
    slash_config: "유효 구성",
    slash_config_locale: "인터페이스 언어(선택기 또는 코드: ru, en, …)",
    slash_models: "모델 제공자",
