...
открыто: двухпроцессный e2e с мок-провайдером (A читает, B пишет,
A видит «⚠»). **Шаг 3** — `/tell`/`/broadcast` (почта готова, нужна
команда). Авторазрешение конфликтов — v3, осознанно.
