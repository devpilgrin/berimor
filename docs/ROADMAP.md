...
этих четырёх задач. A2 и A4 остаются заблокированы задачами вне этой
фазы (S6, P7) — не переносить их в «выполнено» до соответствующих
зависимостей.
...
| A4 | ⛔ Лимит очереди `human_gate` + статус `throttled` для расписаний — заблокирована P7 | M | Средний | A3, P7 | `arch/process-engine.md` §5, ADR-0015 |
